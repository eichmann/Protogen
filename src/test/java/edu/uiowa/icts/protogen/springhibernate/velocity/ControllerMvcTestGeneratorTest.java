...
public class ControllerMvcTestGeneratorTest {
	...
	//	properties.setProperty( "include.schema.in.request.mapping", "false" );	
		...
		assertThat(sourceCode, containsString("mockMvc.perform(get(\"/ictssysadmin/clinicaldocument/list_alt.html\"))"));
		...
		assertThat(sourceCode, containsString("mockMvc.perform(get(\"/ictssysadmin/clinicaldocument/list.html\"))"));
